...
//
// renderUi is a thin wrapper over Testing Library's own `render` -- the one place a later plan
// adds a shared provider (the Radix Tooltip.Provider arrives in Plan 05-24) so every component
// test picks it up automatically instead of each test file wiring its own provider list.
